...
def result_test(real, pred):
    ...
    labels11 = ["00","01","02","03","04","05","06","07","08","09","10","11","12","13","14","15","16","17",
...
def evals():
    """
    评估预训练的ResNet34模型在特定数据集上的性能。

    该函数加载模型权重，对验证数据集进行预测，并将预测结果与真实标签进行比较。
    """
    # 初始化ResNet34模型，设定类别数为40，并将其移动到指定设备上
